...
export class RevokeComponent implements OnInit {
  ...
  ngOnInit() {
    this.formGroup = this.fb.group({
      ...
      commodityName: [{ value: this.recordInfo.cartTypeName, disabled: true }],
      cardCode: [{ value: this.recordInfo.cardCode, disabled: true }],
      consumption: [{ value: this.recordInfo.payment, disabled: true }],
      satisfaction: [{ value: this.recordInfo.satisfaction, disabled: true }],
      swimTeacher: [{ value: this.recordInfo.employeeName, disabled: true }],
      consumeDate: [{ value: this.recordInfo.payTime, disabled: true }],
