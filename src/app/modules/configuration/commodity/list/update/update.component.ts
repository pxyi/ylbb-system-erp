...
export class UpdateComponent implements OnInit {
  ...
  constructor(
    ...
    this.http.post('http://qnewbss.beibeiyue.cn/schedule/schedule/yeqs/cardBusinessManagement/getStoreCardTypeCategores').then(res => this.cardTypeList = res.result);
  }
