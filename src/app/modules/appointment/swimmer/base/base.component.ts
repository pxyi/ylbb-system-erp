...
export class BaseComponent implements OnInit {
  ...
  getData() {
    ...
    this.http.post('/teacherCommonHour/list').then(res => {
  ...
  save() {
    this.http.post('/teacherCommonHour/save', { paramJson: JSON.stringify({ list: this.baseList }) }, true);
  }
  ...
  init() {
    this.modal.confirm({
      ...
      nzMaskClosable: true,
      nzOnOk: () => { this.http.post('/teacherCommonHour/init', {}, true) }
    });
  }
