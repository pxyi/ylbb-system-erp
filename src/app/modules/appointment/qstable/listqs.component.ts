...
@Component({
  selector: 'app-listqs',
  templateUrl: './listqs.component.html',
  styleUrls: ['./listqs.component.less']
})
export class ListqsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.routingPath = "/home/appointment/qstable";
    setTimeout(() => {
