...
export class ConsumptionComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.timesCountGroup.get('commodityId').valueChanges.subscribe(id => {
      this.http.post('http://qnewbss.beibeiyue.cn/schedule/schedule/yeqs/customer/price', { id, cardId: this.timesCountGroup.get('cardId').value, isCrossed: this.appointmentInfo.isCrossed }, false).then(res => {
